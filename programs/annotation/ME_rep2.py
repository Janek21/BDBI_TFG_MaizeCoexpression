...
def main():
    ...
    for i in range(3):#loop trhough all depths and types
        ...
        fileD=open(f"./annotation/Pres/d_{depth}_sheet.txt", "a") #a file for each depth type
        fileT=open(f"./annotation/Pres/anT_{tp}_sheet.txt", "a") #a file for each annotation type
