...
```{r dtLoad}
dataNL<-read.delim("../data/nolen/B73.csv", row.names=1, stringsAsFactors=TRUE)
metadata<-read.delim("../data/nolen/B73_m.txt", header=T, row.names=1, stringsAsFactors=TRUE)
