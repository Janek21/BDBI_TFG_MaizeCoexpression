...
genes_in_module <- names(ModNetwork$colors)[ModNetwork$colors == "darkturquoise"]
MEgene_expression <- as.data.frame(Nrepl_data[, colnames(Nrepl_data) %in% genes_in_module])
```

```{r}
entrez_genes <- genes_in_module
